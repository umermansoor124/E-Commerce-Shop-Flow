    ...
    <div className='pd'>
      <div className='pd-left'>
        <div className='pd-image'>
          ...
          <span className='pd-image-num'>01</span>
        </div>
      ...
      <div className='pd-right'>
        <div className='pd-right-top'>
          <span className='pd-eyebrow'>
            <span className='pd-eyebrow-line'></span>
            {product.category}
          </span>
          <span className='pd-stock'>{product.stock} IN STOCK</span>
        </div>

        <h1 className='pd-name-solid'>{product.name}</h1>
        <h1 className='pd-name-ghost'>DETAIL.</h1>
        ...
        <div className='pd-qty-row'>
          ...
          <div className='pd-qty-controls'>
            ...
            <span>{qty}</span>
            <button onClick={() => setQty(qty < product.stock ? qty + 1 : qty)}>+</button>
          </div>
        </div>
        ...
        <div className='pd-actions'>
          ...
          <button className='pd-btn-secondary'>BUY NOW</button>
        </div>
      </div>
    </div>
  )
